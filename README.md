...
<details>
<summary>
ViT-Small and ViT-Tiny follow the same hyperparameter settings as ViT-Base for MAE pre-training, except for the --model and --output_dir arguments.
</summary>
...
<details>
<summary>
ViT-Small and ViT-Tiny follow the same hyperparameter settings as ViT-Base for MAE fine-tuning, except for the --model and --finetune arguments.
</summary>
